    ...
    public void onCreate() {
      ...
      */
        ...
        if (Build.VERSION.SDK_INT>= Build.VERSION_CODES.Q){
            ...
            final WifiNetworkSuggestion gedungAH = new WifiNetworkSuggestion.Builder()
                    .setSsid("Alfanshter")
                    .setWpa2Passphrase("")
                    .build();
            final WifiNetworkSuggestion gedungAL = new WifiNetworkSuggestion.Builder()
                    .setSsid("Novian")
                    .setWpa2Passphrase("novian123")
                    .build();
            final List<WifiNetworkSuggestion> suggestionsList =
                    new ArrayList<WifiNetworkSuggestion>();
            suggestionsList.add(gedungAH);
            suggestionsList.add(gedungAL);
