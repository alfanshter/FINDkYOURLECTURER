...
//    datadosen datadosen;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        lv_tahunmasuk = findViewById(R.id.tahunmasuk);
//        final int pilihbt = mPilihUser.getCheckedRadioButtonId();

        FirebaseApp.initializeApp(this);
        user2 = new datadosen();
        user3 = new datamhs();
        mDosen.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                lv_tahunmasuk.setVisibility(View.INVISIBLE);

            }
        });

        mMahasiswa.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                lv_tahunmasuk.setVisibility(View.VISIBLE);
